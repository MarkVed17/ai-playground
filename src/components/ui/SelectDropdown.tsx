...
>(
  (
    { className, options, label, error, required, placeholder, id, ...props },
    ref
  ) => {
      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ...
            id={selectId}
            className={clsx(
              "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm appearance-none text-gray-700",
...
export interface CustomSelectDropdownProps
  extends Omit<SelectDropdownProps, "children"> {
